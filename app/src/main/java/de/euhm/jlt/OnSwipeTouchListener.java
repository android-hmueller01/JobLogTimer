...
public class OnSwipeTouchListener implements OnTouchListener {
	...
	public OnSwipeTouchListener(Context context, View view) {
		...
		mHandler = new GestureHandler(this, Looper.getMainLooper());
	}
	...
	private static class GestureHandler extends Handler {
		...
		GestureHandler(OnSwipeTouchListener myClassInstance, Looper looper) {
			super(looper); // Call the superclass constructor with the looper
